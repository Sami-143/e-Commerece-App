...
router.route('/reviews').get(isAuthenticatedUser, getProductReviews); // Get all reviews
router.route('/review').delete(isAuthenticatedUser, deleteReview); // Delete a review
